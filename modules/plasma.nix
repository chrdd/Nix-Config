{ config, lib, pkgs, plasma-manager, ... }:
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-50cf6b35-e207-493b-87e2-d28f7f75dc52" = [ ];
      ...
      "kwin"."Window to Desktop 16" = "none,,Window to Desktop 16";                                                                                                                                  "kwin"."Window to Desktop 17" = "none,,Window to Desktop 17";
      ...
      "mediacontrol"."nextmedia" = "Media Next";                                                                                                                                                     "mediacontrol"."pausemedia" = "Media Pause";
      ...
      "services/com.mitchellh.ghostty.desktop"."_launch" = "Ctrl+Shift+X";
      "services/floorp.desktop"."_launch" = "Ctrl+Shift+B";
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."2 screens: Height" = 540;
      "dolphinrc"."ExtractDialog"."2 screens: Width" = 1256;
      "dolphinrc"."ExtractDialog"."DirHistory[$e]" = "$HOME/Documents/ArhivaSem1/";
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,1,3,23,45,2.507";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."50cf6b35-e207-493b-87e2-d28f7f75dc52" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "50cf6b35-e207-493b-87e2-d28f7f75dc52";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{6617531e-2382-4bad-900c-3ee47650bc47}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{b6d99972-5a72-4bc5-bff5-c264be8cb6ff}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{14a2b486-3bb6-42de-ab9c-a0d0a09445de}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{8a83d771-f5f2-4759-918f-2eb37618ca59}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{bc1c9f80-be5f-47b3-96e6-b29855aa6784}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{d4bacaae-dfc8-482a-975d-d489a2f6ed77}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{11e9c16e-0b06-4503-a3d6-3bdf8869ac56}";
      ...
      "kwinrc"."Desktops"."Id_1" = "cbdfdd95-05f4-4b0f-8600-b05300277d9d";
      "kwinrc"."Desktops"."Id_2" = "045d5557-23c1-4de5-bb7b-2bbd6d2c812c";
      "kwinrc"."Desktops"."Id_3" = "d5ffba90-b93b-4f95-a185-eafb880221ca";
      ...
      "kwinrc"."Tiling/0ca5e00f-3f78-52f3-96c5-9ce1f0bf4f7f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/302c6fd7-0710-5640-85ef-47a46bd08ef0"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/32de7d9f-6152-5a52-9f75-9191308f3929"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "plasmanotifyrc"."Applications/plexamp"."Seen" = true;
      "plasmanotifyrc"."Notifications"."PopupTimeout" = 2000;
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/octavian/Downloads/wallhaven-zykp1w_3840x2160.png";
      "spectaclerc"."GuiConfig"."captureMode" = 0;
      "spectaclerc"."ImageSave"."lastImageSaveAsLocation" = "file:///home/octavian/Pictures/Screenshots/Screenshot_20250114_200744.png";
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/octavian/Pictures/Screenshots/Screenshot_20250119_151720.png";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."Encoding" = "ISO-8859-15";
      "kate/anonymous.katesession"."Document 0"."Highlighting" = "JSON";
      ...
      "kate/anonymous.katesession"."Document 0"."Mode" = "JSON";
      "kate/anonymous.katesession"."Document 0"."Mode Set By User" = false;
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/octavian/Downloads/secrets.json";
      ...
      "kate/anonymous.katesession"."MainWindow0"."2 screens: Height" = 1052;
      "kate/anonymous.katesession"."MainWindow0"."2 screens: Width" = 959;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 946;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 642;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,946,0";
      "kate/anonymous.katesession"."MainWindow0"."ToolBarsMovable" = "Disabled";
      "kate/anonymous.katesession"."MainWindow0 Settings"."2 screens: Height" = 1052;
      "kate/anonymous.katesession"."MainWindow0 Settings"."2 screens: Width" = 959;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = "file:///home/octavian/Downloads/secrets.json";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Count" = 1;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Documents" = "file:///home/octavian/Downloads/secrets.json";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 0" = "file:///home/octavian/Downloads/secrets.json";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/octavian\\/Downloads\\/secrets.json"."CursorColumn" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/octavian\\/Downloads\\/secrets.json"."CursorLine" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/octavian\\/Downloads\\/secrets.json"."Dynamic Word Wrap" = true;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/octavian\\/Downloads\\/secrets.json"."JumpList" = "";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/octavian\\/Downloads\\/secrets.json"."TextFolding" = "{\"checksum\":\"f9012e2f5feaf6e19f29e01aa5686168f39cd880\",\"ranges\":[]}";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/octavian\\/Downloads\\/secrets.json"."ViMarks" = "";
